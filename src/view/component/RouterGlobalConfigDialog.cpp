...
QMap<QString, QString> RouterGlobalConfigDialog::getDefaultConfig() {
    ...
    defaultConfig["xr"] = "1";
    defaultConfig["yr"] = "1";
    defaultConfig["link_failures"] = "0";
    defaultConfig["fail_seed"] = "0";
    defaultConfig["in_ports"] = "5";
    defaultConfig["out_ports"] = "5";
    defaultConfig["router"] = "iq";
    defaultConfig["output_delay"] = "0";
    ...
    defaultConfig["spec_check_elig"] = "1";
    defaultConfig["spec_check_cred"] = "1";
    defaultConfig["spec_mask_by_reqs"] = "0";
    defaultConfig["spec_sw_allocator"] = "prio";
    defaultConfig["num_vcs"] = "8";
    defaultConfig["vc_buf_size"] = "16";
    defaultConfig["buf_size"] = "-1";
    defaultConfig["buffer_policy"] = "private";
    defaultConfig["private_bufs"] = "-1";
    defaultConfig["private_buf_size"] = "1";
    defaultConfig["private_buf_start_vc"] = "-1";
    defaultConfig["private_buf_end_vc"] = "-1";
    defaultConfig["max_held_slots"] = "-1";
    defaultConfig["feedback_aging_scale"] = "1";
    defaultConfig["feedback_offset"] = "0";
    defaultConfig["wait_for_tail_credit"] = "1";
    defaultConfig["vc_busy_when_full"] = "0";
    defaultConfig["vc_prioritize_empty"] = "0";
    defaultConfig["vc_priority_donation"] = "0";
    ...
    defaultConfig["st_prepare_delay"] = "0";
    defaultConfig["st_final_delay"] = "1";
    defaultConfig["vct"] = "0";
    defaultConfig["vc_allocator"] = "islip";
    defaultConfig["sw_allocator"] = "islip";
    defaultConfig["arb_type"] = "round_robin";
    defaultConfig["alloc_iters"] = "1";
    defaultConfig["classes"] = "1";
    defaultConfig["traffic"] = "uniform";
    defaultConfig["class_priority"] = "0";
    defaultConfig["perm_seed"] = "0";
    defaultConfig["injection_rate"] = "0.05";
    defaultConfig["injection_rate_uses_flits"] = "0";
    defaultConfig["packet_size"] = "5";
    defaultConfig["packet_size_rate"] = "1";
    defaultConfig["injection_process"] = "bernoulli";
    defaultConfig["burst_alpha"] = "0.5";
    defaultConfig["burst_beta"] = "0.5";
    defaultConfig["burst_r1"] = "-1.0";
    defaultConfig["priority"] = "none";
    defaultConfig["batch_size"] = "1000";
    defaultConfig["batch_count"] = "1";
    defaultConfig["max_outstanding_requests"] = "0";
    defaultConfig["use_read_write"] = "0";
    defaultConfig["write_fraction"] = "0.5";
    defaultConfig["read_request_begin_vc"] = "0";
    defaultConfig["read_request_end_vc"] = "3";
    defaultConfig["write_request_begin_vc"] = "4";
    defaultConfig["write_request_end_vc"] = "7";
    defaultConfig["read_reply_begin_vc"] = "0";
    defaultConfig["read_reply_end_vc"] = "3";
    defaultConfig["write_reply_begin_vc"] = "4";
    defaultConfig["write_reply_end_vc"] = "7";
    defaultConfig["read_request_subnet"] = "0";
    defaultConfig["read_reply_subnet"] = "0";
    defaultConfig["write_request_subnet"] = "0";
    defaultConfig["write_reply_subnet"] = "0";
    defaultConfig["read_request_size"] = "1";
    defaultConfig["write_request_size"] = "1";
    defaultConfig["read_reply_size"] = "4";
    defaultConfig["write_reply_size"] = "4";
    defaultConfig["sim_type"] = "latency";
    defaultConfig["warmup_periods"] = "3";
    defaultConfig["sample_period"] = "5000";
    defaultConfig["max_samples"] = "10";
    defaultConfig["measure_stats"] = "1";
    defaultConfig["pair_stats"] = "0";
    defaultConfig["latency_thres"] = "1000.0";
    defaultConfig["warmup_thres"] = "0.05";
    defaultConfig["acc_warmup_thres"] = "0.05";
    defaultConfig["stopping_thres"] = "0.05";
    defaultConfig["acc_stopping_thres"] = "0.05";
    defaultConfig["sim_count"] = "1";
    defaultConfig["include_queuing"] = "1";
    defaultConfig["seed"] = "42";
    defaultConfig["print_activity"] = "0";
    defaultConfig["print_csv_results"] = "0";
    defaultConfig["deadlock_warn_timeout"] = "512";
    defaultConfig["viewer_trace"] = "0";
    defaultConfig["watch_file"] = "";
    defaultConfig["watch_flits"] = "";
    defaultConfig["watch_packets"] = "";
    defaultConfig["watch_transactions"] = "";
    defaultConfig["watch_out"] = "";
    defaultConfig["stats_out"] = "";
    defaultConfig["sim_power"] = "0";
    defaultConfig["power_output_file"] = "pwr_tmp";
